...
def gui():
    ...
    root.title('Cold turkey blocker Activator')
        ...
        try:
            ...
            if os.path.exists(DB_PATH):
                ...
                if data["additional"]["proStatus"] != "pro":
                    ...
                    connector.commit()
                    output('Cold turkey blocker activated.\nPlease restart cold turkey blocker.\nPress any key to continue...','#00FF00')
                else:
                    output('Cold turkey blocker already activated.\nPress any key to continue...','#00FF00')
